...
class Manufaktur extends CI_Controller {
  ...
  function tambah(){
    $data['d_manufaktur']  = $this->m->ambilData(); //jalankan fungsi ambilDataTipe, simpan ke $data

    $this->load->view('header');
    $this->load->view('leftside');
    $this->load->view('manufaktur/tambah', $data);
    $this->load->view('footer');
  }
  ...
  function submit(){
    ...
    redirect(base_url('manufaktur/index'));
  }

  function ubah ($id){
    $data['d_manufaktur']  = $this->m->ambilDataID($id); //jalankan fungsi ambilData berdasarkan ID, simpan ke $data

    $this->load->view('header');
    $this->load->view('leftside');
    $this->load->view('manufaktur/ubah', $data);
    $this->load->view('footer');
