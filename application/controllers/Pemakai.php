...
class Pemakai extends CI_Controller {
  ...
  function __construct(){
    parent:: __construct();
    $this->load->model('m_pemakai','m'); //load model, simpan ke m
    $this->load->model('m_departemen','md'); //load model pemakai, simpan ke mk
    ...
    $config['base_url'] = base_url() . 'pemakai/index';
