  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="box box-default">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('lokasi/update')?>" method="post" class="form-horizontal">
                  <!-- kategori -->
                  <div class="form-group ">
                      <label for="kategori" class="col-md-3 control-label">Nama lokasi</label>
                      <div class="col-md-7 col-sm-12 required">
                        <input type="text" value="<?php echo $d_lokasi->lokasi; ?>" name="txt_lokasi" class="form-control" required>
                      </div>
                  </div>
                  ...
                  <input type="hidden" name="txt_id" value="<?php echo $d_lokasi->id;?>"/>
                </form>
              </div>
          </div>
      </div> <!-- col -->
