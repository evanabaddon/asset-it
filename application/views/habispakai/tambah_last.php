        ...
        <div class="box box-default">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('pemakai/submit')?>" method="post" class="form-horizontal">
                  ...
                  <!-- nik -->
                  <div class="form-group ">
                      <label for="pemakai" class="col-md-3 control-label">NIK</label>
                      <div class="col-md-7 col-sm-12 required">
                        <input type="text" name="txt_nik" class="form-control" placeholder="Nomor Induk Karyawan...">
                      </div>
                  </div>
                  <!-- manufaktur -->
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                      ...
                      <div class="col-md-7 col-sm-12 required">
                        <input type="text" name="txt_alamat" class="form-control" placeholder="Alamat...">
                      </div>
                  </div>
                  <!-- no_telp -->
                  <div class="form-group ">
