        ...
        <div class="box box-default">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('habispakai/checkin')?>" method="post" class="form-horizontal">
                  ...
                  <input type="hidden" name="txt_id_habispakai" value="<?php echo $d_habispakai->id;?>"/>
                  <input type="hidden" name="txt_stok" value="<?php echo $d_habispakai->stok;?>"/>
                  <input type="hidden" name="txt_id_model" value="<?php echo $d_model->id;?>"/>
                </form>
            </div>
        </div>
    </div> <!-- col -->
